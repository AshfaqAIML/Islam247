...
import { namesOfAllah, namesVirtue } from "@/lib/data/names";
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
            Reflect upon the divine attributes — each name a doorway to knowing
            Allah and drawing closer to Him.
          </p>
        </div>
      </motion.header>
        ...
        <Card className="relative overflow-hidden rounded-2xl border border-gold/20 bg-gold-soft/10 p-5 sm:p-6">
          ...
          <div className="relative z-10 flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <blockquote className="mt-1 text-sm italic leading-relaxed text-foreground sm:text-base">
                &ldquo;{namesVirtue}&rdquo;
              </blockquote>
            </div>
          </div>
        </Card>
      ...
      <div className="px-6 pb-6 pt-5">
        ...
        <div className="mt-5 flex items-start gap-2 rounded-xl border border-gold/20 bg-gold-soft/10 p-3">
          ...
          <p className="text-xs italic leading-relaxed text-muted-foreground">
            Reciting and reflecting upon the Names of Allah draws the servant
            closer to Him. The Prophet ﷺ said that whoever enumerates all
            ninety-nine will enter Paradise, by Allah&rsquo;s mercy.
          </p>
        </div>
